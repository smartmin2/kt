const mainMenu = [
  { id: 1, name: "소재", link: "/pages/material/processing.html" },
...
const subMenu = {
  1: [
    {
      id: 1,
      name: "OTV 소재가공",
      link: "/pages/material/processing.html",
      folder: [
        { name: "소재가공 (+소재 다운로드)", link: "/pages/material/processing.html" },
    ...
    },
    {
      id: 2,
      name: "OTV",
      link: "/pages/material/video_material.html",
      folder: [
        {
          name: "동영상",
          link: "",
          folder: [
            { name: "소재", link: "/pages/material/video_material.html" },
  ...
  2: [
    {
      id: 1,
      name: "캠페인",
      link: "/pages/contract/campaign.html",
      folder: [
        { name: "캠페인", link: "/pages/contract/campaign.html" },
    ...
    },
    {
      id: 2,
      name: "청약 관리",
      link: "/pages/contract/sub_default_ad.html",
      folder: [
        { name: "DEFAULT 광고 관리", link: "/pages/contract/sub_default_ad.html" },
    ...
    },
    {
      id: 3,
      name: "캠페인 추가 서비스",
      link: "/pages/contract/campaign_video.html",
      folder: [
        { name: "동영상", link: "/pages/contract/campaign_video.html" },
  ...
  3: [
    { id: 1, name: "영업권 관리", link: "/pages/business/goodwill_mng.html", folder: [] },
  ...
  4: [
    { id: 1, name: "통합 카테고리 관리", link: "/pages/category/category_manage.html", folder: [] },
  ...
  5: [
    { id: 1, name: "생성", link: "/pages/inventory/produce.html", folder: [] },
    {
      id: 2,
      name: "동영상",
      link: "/pages/inventory/video_cf.html",
      folder: [
        { name: "예측 및 확정", link: "/pages/inventory/video_cf.html" },
    ...
    },
    {
      id: 3,
      name: "양방향",
      link: "/pages/inventory/twoway_cf_adq.html",
      folder: [
        { name: "예측 및 확정", link: "/pages/inventory/twoway_cf_adq.html" },
    ...
    },
    {
      id: 4,
      name: "LiveAD",
      link: "/pages/inventory/livead_cf.html",
      folder: [
        { name: "예측 및 확정", link: "/pages/inventory/livead_cf.html" },
        { name: "LiveAD 인벤토리 조회", link: "/pages/inventory/livead_inven.html" },
      ],
    },
  ],
  6: [
    { id: 1, name: "명세서", link: "/pages/billing/specification.html", folder: [] },
    {
      id: 2,
      name: "정산",
      link: "/pages/billing/entire_bm.html",
      folder: [
        { name: "전체 BM", link: "/pages/billing/entire_bm.html" },
  ...
  7: [
    {
      id: 1,
      name: "OTV",
      link: "/pages/organization/organization_vod.html",
      folder: [
        {
          name: "상용광고 편성관리",
          link: "",
          folder: [
            { name: "VOD 편성", link: "/pages/organization/organization_vod.html" },
        ...
        },
        {
          ...
          link: "",
          folder: [
            { name: "소재", link: "/pages/organization/ad_mng_icod.html" },
        ...
        },
        {
          ...
          link: "",
          folder: [
            { name: "소재", link: "/pages/organization/his_mng_icod.html" },
    ...
    },
    {
      id: 2,
      name: "홈쇼핑",
      link: "/pages/organization/home_org_info.html",
      folder: [
        { name: "홈쇼핑 편성정보", link: "/pages/organization/home_org_info.html" },
  ...
  8: [
    {
      id: 1,
      name: "OTV",
      link: "/pages/report/live_statistics.html",
      folder: [
        { name: "LIVE통계조회", link: "/pages/report/live_statistics.html" },
        { name: "Input Log 조회", link: "/pages/report/input_log.html" },
        { name: "청약진행현황", link: "/pages/report/subscription.html" },
      ],
    },
    { id: 2, name: "모니터링", link: "/pages/report/monitoring.html", folder: [{ name: "LiveAD 청약현황", link: "/pages/report/monitoring.html" }] },
    {
      id: 3,
      name: "광고노출현황",
      link: "/pages/report/exposure_ad.html",
      folder: [
  ...
  9: [
    {
      id: 1,
      name: "통합 대시보드",
      link: "/pages/statistics/integration.html",
      folder: [
        { name: "통합통계", link: "/pages/statistics/integration.html" },
    ...
    },
    {
      id: 2,
      name: "매체정보",
      link: "/pages/statistics/subscriber_trend.html",
      folder: [
        {
          name: "OTV",
          link: "",
          folder: [
            { name: "가입자 추세", link: "/pages/statistics/subscriber_trend.html" },
    ...
    { id: 3, name: "운영분석", link: "/pages/statistics/indus_class_prog.html", folder: [{ name: "매출현황", link: "", folder: [{ name: "OTV > 업종 분류별 진행 현황", link: "/pages/statistics/indus_class_prog.html" }] }] },
    {
      id: 4,
      name: "광고 효과 분석",
      link: "/pages/statistics/adver_by_adver.html",
      folder: [
        { name: "캠페인 총괄 분석", link: "", folder: [{ name: "광고주별 광고 집행 통계", link: "/pages/statistics/adver_by_adver.html" }] },
        { name: "OTV", link: "", folder: [{ name: "캠페인 총괄통계", link: "/pages/statistics/campaign_total.html" }] },
      ],
    },
    { id: 5, name: "타겟 분석", link: "/pages/statistics/integrated_analysis.html", folder: [{ name: "통합분석", link: "/pages/statistics/integrated_analysis.html" }] },
    {
      id: 6,
      name: "가족 구성원 추론",
      link: "/pages/statistics/contents_mapping.html",
      folder: [
        { name: "콘텐츠 매핑", link: "/pages/statistics/contents_mapping.html" },
  ...
  10: [
    {
      id: 1,
      name: "회원 관리",
      link: "/pages/services/company.html",
      folder: [
    ...
    },
    {
      id: 2,
      name: "OTV 관리",
      link: "/pages/services/channel.html",
      folder: [
        {
          name: "동영상",
          link: "/pages/services/channel.html",
          folder: [
            { name: "채널정보관리", link: "/pages/services/channel.html" },
        ...
        {
          name: "ADQ 2.0",
          link: "/pages/services/quiz.html",
          folder: [
            { name: "설문/퀴즈관리", link: "/pages/services/quiz.html" },
    ...
    { id: 3, name: "타겟분석", link: "/pages/services/target.html", folder: [] },
    {
      id: 4,
      name: "설정",
      link: "/pages/services/setotv_movie.html",
      folder: [
        { name: "OTV", link: "/pages/services/setotv_movie.html", folder: [{ name: "동영상", link: "/pages/services/setotv_movie.html" }] },
        {
          name: "양방향",
          link: "/pages/services/settw_stbox.html",
          folder: [
            { name: "테스트셋탑박스관리", link: "/pages/services/settw_stbox.html" },
    ...
    { id: 7, name: "요구사항 관리", link: "/pages/services/request.html", folder: [] },
    {
      id: 8,
      name: "단가관리",
      link: "/pages/services/unitprice_op.html",
      folder: [
        { name: "OTV/PrePlay+", link: "/pages/services/unitprice_op.html" },
        { name: "단가/할인정보 관리", link: "/pages/services/discount_info.html" },
      ],
    },
  ],
  11: [
    { id: 1, name: "사용자 관리", link: "/pages/system/user.html", folder: [] },
...
function loadSubMenu(sActive, iSub) {
  ...
  for (const [key, value] of Object.entries(subMenu)) {
    ...
    value.map((subitem, i) => {
      var li = document.createElement("li");
      if (key == sActive && i == iSub - 1) li.classList.add("active");
...
$(function () {
  ...
  $(".header-wrapper").on("mouseleave", function () {
    ...
    if ($("ul.main-menu li.active").hasClass("not-hover") == false) $("ul.main-menu li.active").addClass("not-hover");
  });
