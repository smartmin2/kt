  ...
  const subMenu = {
    ...
    4 : [{id: 1, name:'통합 카테고리 관리', link:'/pages/category/category_manage.html', folder: []},
         ...
         {id: 9, name:'캠페인 통합 카테고리 그룹 관리', link:'/pages/category/cam_categroup.html', folder: []},
         {id: 10, name:'가상 그룹 관리', link:'/pages/category/virtual_group.html', folder: []},         
         {id: 11, name:'통합 카테고리 Slot관리(POST)', link:'/pages/category/category_slot_post.html', folder: []}],
    ...
    7 : [{id: 1, name:'OTV', link:'/pages/organization/organization_vod.html', 
         ...
         {id: 2, name:'홈쇼핑', link:'', 
            folder: [{name:'홈쇼핑 편성정보', link:''},
                     ...
                     {name:'홈쇼핑 채널관리', link:''}]}],
    8 : [{id: 1, name:'OTV', link:'/pages/report/live_statistics.html', 
